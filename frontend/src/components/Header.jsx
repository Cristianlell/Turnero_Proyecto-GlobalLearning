      ...
      <div className="container flex items-center justify-center md:justify-around">
        ...
        <nav id="navbar" className="navbar hidden md:flex justify-center">
          <ul className="flex flex-row space-x-4 text-lg"> {/* Tamaño de fuente aumentado */}
            ...
            <li><Link className="text-blue-600 hover:text-blue-800 transition-all duration-200 ease-in-out" to="/login">Login</Link></li>
            {
              isLoggedin
                ?
                <li><Link className="text-blue-600 hover:text-blue-800 transition-all duration-200 ease-in-out" to="/dashboard">Dashboard</Link></li>
                : null
            }
